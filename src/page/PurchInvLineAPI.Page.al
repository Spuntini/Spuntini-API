page 55033 "SP Purch. Inv. Line API"
{
    PageType = API;
    Caption = 'Purchase Invoice Line API', Locked = true;
    ...
    layout
    {
        area(Content)
        {
            field(addNoEmptyGoods; Rec."Add No Empty Goods")
            {
            }
            ...
            field(emptyGoods; Rec."Empty Goods")
            {
            }
            field(emptyGoodsFromLineNo; Rec."Empty Goods From Line No.")
            {
            }
            field(emptyGoodsLineNo; Rec."Empty Goods Line No.")
            {
            }
