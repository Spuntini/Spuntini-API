page 55024 "SP Sales Invoice Header API"
{
    PageType = API;
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field(applicableForServDecl; Rec."Applicable For Serv. Decl.")
                {
                    Caption = 'Applicable For Service Declaration', Locked = true;
                }
                ...
                field(cflAmountInclCreditLimit; Rec."CFL Amount incl. Credit Limit.")
                {
                    Caption = 'Amount incl. credit limitation', Locked = true;
                }
                field(cflCreditLimitation; Rec."CFL Credit Limitation")
                {
                    Caption = 'Credit Limitation %', Locked = true;
                }
                field(cflCreditLimitationAmount; Rec."CFL Credit Limitation Amount")
                {
                    Caption = 'Credit Limitation Amount', Locked = true;
                }
                field(cflDateTimeRegisterReject; Rec."CFLW1 DateTime RegisterReject")
                {
                    Caption = 'Date-Time for Register/Reject', Locked = true;
                }
                field(cflELOID; Rec."CFLW1 ELOID")
                {
                    Caption = 'ELOID', Locked = true;
                }
                field(cflImport; Rec."CFLW1 Import")
                {
                    Caption = 'Import', Locked = true;
                }
                field(cflImportedDateTime; Rec."CFLW1 Imported Date-Time")
                {
                    Caption = 'Imported Date-Time', Locked = true;
                }
                field(cflOCRProcessCompleted; Rec."CFLW1 OCR Process Completed")
                {
                    Caption = 'OCR Process Completed', Locked = true;
                }
                field(cflPostingDateTime; Rec."CFLW1 Posting Date-Time")
                {
                    Caption = 'Posting Date-Time', Locked = true;
                }
                field(cflStandardFormatMessage; Rec."CFLW1 Standard Format Message")
                {
                    Caption = 'Standard Format Message', Locked = true;
                }
                field(cflVATCalculation; Rec."CFL VAT Calculation")
                {
                    Caption = 'VAT Calculation', Locked = true;
                }
                ...
                {
                    Caption = 'Dispute Status', Locked = true;
                }
                field(disputeStatusId; Rec."Dispute Status Id")
                {
                    Caption = 'Dispute Status Id', Locked = true;
                }
...
#pragma warning restore
                ...
                {
                    Caption = 'Promised Pay Date', Locked = true;
                }
