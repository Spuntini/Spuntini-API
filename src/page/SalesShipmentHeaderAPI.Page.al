page 55018 "SP Sales Shipment Header API"
{
    PageType = API;
    Caption = 'Sales Shipment Header', Locked = true;
...
#pragma warning restore
                ...
                {
                    Caption = 'Route', Comment = 'nl-BE=Route', Locked = true;
                }
                ...
                {
                    Caption = 'Total amount', Comment = 'nl-BE=Totaalbedrag', Locked = true;
                }
                field(totalAmountInclVAT; Rec."Total amount (incl. VAT)")
                {
                    Caption = 'Total amount (incl VAT)', Comment = 'nl-BE=Totaalbedrag (incl BTW)', Locked = true;
                }
                field(totalVAT; Rec."Total VAT")
                {
                    Caption = 'Total VAT', Comment = 'nl-BE=Totaal BTW', Locked = true;
                }
